...
export default function Home() {
  return <main>
    ...
    <section className="container py-5"><div className="row g-4"><div className="col-md-4"><div className="feature"><span>01</span><h4>Discover talent</h4><p>Search a focused marketplace of creator services.</p></div></div><div className="col-md-4"><div className="feature"><span>02</span><h4>Book with context</h4><p>Send your requirements and preferred delivery date.</p></div></div><div className="col-md-4"><div className="feature"><span>03</span><h4>Manage bookings</h4><p>Creators accept or decline requests and clients see live status.</p></div></div></div></section>
  </main>;
}
